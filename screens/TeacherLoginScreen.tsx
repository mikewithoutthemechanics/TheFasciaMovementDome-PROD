...
export const TeacherLoginScreen: React.FC<TeacherLoginScreenProps> = ({ onBack, onSignIn }) => {
    ...
    try {
      if (isSupabaseConfigured() && supabase) {
        ...
        if (data.user) {
          ...
          if (!response.ok) {
            throw new Error("Unable to verify teacher status");
          }
          ...
          if (statusData.status !== 'approved') {
            ...
            throw new Error("Your teacher account is not yet approved. Please contact admin.");
          }
      ...
      <div className="w-full max-w-lg flex flex-col items-center justify-center">
        ...
        >
          <div className="text-center mb-2">
            ...
            <h1 className="text-[#FBF7EF] text-xl font-bold">Teacher Portal</h1>
            <p className="text-[#FBF7EF]/50 text-xs mt-1">Sign in with your approved teacher account</p>
          </div>
          ...
          >
            ...
            <p className="text-center text-[#FBF7EF]/30 text-[9px]">
              Approved teachers only. Contact admin for access.
            </p>
          </motion.form>
        </motion.div>
      </div>
